...
def register():
    ...
    if form.validate_on_submit():
        ...
        # If user's email already exists, redirect to /login.
...
def login():
    ...
    if form.validate_on_submit():
        ...
        # Target user in DB based on email provided in the LoginForm.
...
def show_post(post_id):
    ...
    if form.validate_on_submit():
        if not current_user.is_authenticated:
            flash("You need to login or register before you can comment.")
            return redirect(url_for("login"))
